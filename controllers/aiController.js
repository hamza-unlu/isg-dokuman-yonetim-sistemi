...
exports.saglikKontrol = async (req, res) => {
    try {
        ...
        res.json({ saglik: 'iyi', mesaj: 'Gemini API erişilebilir', testYaniti: testYaniti.trim().substring(0, 50), model: 'gemini-2.0-flash', kategoriSayisi: ISG_KATEGORILERI.length });
    } catch (err) {
